...
classes_botigues = ClasseBotiga.create([{ nom: 'Roba' }, { nom: 'Sabates' }, { nom: 'Menjar' }, { nom: 'Supermercat' }, { nom: 'Souvenirs' }, { nom: 'Joguines' }, { nom: 'Decoració' }, { nom: 'Altres' }])
...
classes_restaurant = ClasseRestaurant.create([{ nom: 'Xinès' }, { nom: 'Italià' }, { nom: 'Francès' }, { nom: 'Americà' }, { nom: 'Mediterrani' }, { nom: 'Indi' }, { nom: 'Tailandès' }, { nom: 'Japonès' }, { nom: 'Argentí' }, { nom: 'Pastisseria' }, { nom: 'Altres' }])
